                ...
                <form action="{{ route('profile-update') }}" enctype="multipart/form-data" method="post">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6 {{ $errors->has('zip') ? ' has-error' : '' }}">
                            ...
                            <input type="text" required="" class="form-control zipCode" name="zip" value="{{ $users->zip }}" placeholder="Zip">
                            @if($errors->has('zip'))
                            <span class="help-block">
                        ...
                        <div class="form-group col-md-6 {{ $errors->has('city') ? ' has-error' : '' }}">
                            ...
                            <input type="text" required="" class="form-control" id="city" name="city" value="{{ $users->city }}" placeholder="City">
                            @if($errors->has('city'))
                            <span class="help-block">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6 {{ $errors->has('state') ? ' has-error' : '' }}">
                            ...
                            <input type="text" required="" class="form-control" id="state" value="{{ $users->state }}" name="state" placeholder="State">
                            @if($errors->has('state'))
                            <span class="help-block">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input style="display: none;" id="file_type" name="profile_image" class="file" type="file">
                            <span class="label label-info" id="upload-file-info"></span>
                        </div>
                        <div class="form-group col-md-6">
                            <div class="form-group text-center">
                                @if(!empty($users->user_image))
                                <img height="150px" id="blah" src="{{ URL::asset('/user_images').'/'.$users->user_image }}">
                                @else
