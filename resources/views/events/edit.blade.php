                ...
                <form action="{{ route('events.update',$events->id)}}" method="post">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control timepicker" name="happy_time_from" value="{{ @$happy_hour->happy_time_from }}">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="happy_time_to" class="col-form-label">Time To</label>
                            <input type="text" class="form-control timepicker" name="happy_time_to" value="{{ @$happy_hour->happy_time_to }}">
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control timepicker" name="brunch_time_from" value="{{ @$brunch_hour->brunch_time_from }}">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="brunch_time_to" class="col-form-label">Time To</label>
                            <input type="text" class="form-control timepicker" name="brunch_time_to" value="{{ @$brunch_hour->brunch_time_to }}">
                        </div>
                    </div>
